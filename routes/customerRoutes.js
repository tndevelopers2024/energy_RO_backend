...
const { getCustomers, createCustomer, updateCustomer, getProducts, updateServiceStatus, activateAcmc, cancelAcmc, deleteCustomer } = require('../controllers/customerController');
